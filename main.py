...
palabras_clave = {
    ...
    "DIONISIO": ["IRON-MAN", "THOR", "EDGARD A POE", "POE", "GARCIA MARQUEZ","ROJO", "VIOLETA", "TIERRA", "MADERA", "HUFFELPURFF", "SERPIENTE CORNUDA", "FACEBOOK", "INSTAGRAM", "ASADO", "PICADA", "GASEOSA", "VINO", "PLAYA ROJA", "CEBU", "DELFINIO", "GLADIOLO"],  # Completar,
    "HADES": [],  # Completar,
    "IRIS": [],  # Completar,
    "HYPNOS": [],  # Completar,
    "NÉMESIS": [],  # Completar,
