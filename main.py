...
palabras_clave = {
    "ZEUS": ["CAPITÁN AMERICA", "THOR", "JULIO VERNE", "GARCÍA MARQUEZ", "BLANCO", 
             "AMARILLO", "AIRE", "ORO", "GRYFINDOR", "THUNDERBIRD", "FACEBOOK", 
             "INSTAGRAM", "PASTAS", "ASADO", "CAFÉ", "VINO", "MONTE RORAIMA", 
